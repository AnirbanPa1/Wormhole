...
const styles = StyleSheet.create({
  ...
  card: {backgroundColor: colors.paper, borderWidth: 1, borderColor: colors.border, borderRadius: 18, padding: 16, shadowColor: colors.shadow, shadowOpacity: 0.05, shadowRadius: 12, shadowOffset: {width: 0, height: 6}, elevation: 2},
  ...
  primaryButton: {height: 46, borderRadius: 15, marginTop: 16, backgroundColor: colors.ink, alignItems: 'center', justifyContent: 'center'},
  primaryButtonText: {fontSize: 14, color: colors.focus, fontWeight: '900'},
  primaryButtonDark: {backgroundColor: colors.focus},
  primaryButtonTextDark: {color: colors.ink},
  busyButtonContent: {flexDirection: 'row', alignItems: 'center', gap: 9},
  modelProgressTrack: {height: 6, marginTop: 10, borderRadius: 3, overflow: 'hidden', backgroundColor: colors.border},
  modelProgressTrackDark: {backgroundColor: colors.darkBorder},
  modelProgressFill: {height: 6, borderRadius: 3, backgroundColor: colors.focus},
  ...
  choiceDark: {backgroundColor: colors.darkSurfaceRaised, borderColor: colors.darkBorder},
  choiceActive: {backgroundColor: colors.focus, borderColor: colors.ink},
